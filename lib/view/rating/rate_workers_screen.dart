      ...
      child: Scaffold(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  15.ph,
                  Text('Wroker1 name',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  25.ph,
        ...
        bottomNavigationBar:Container(
          ...
          child: Padding(
            ...
            child:
            CustomButtonTWo(screenUtil: screenUtil, color: ColorApp.primary, color1: Colors.white, txt: 'Next >>',onTap: (){
              Get.back();
            },),
          ),
        ),
